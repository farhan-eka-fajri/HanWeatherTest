...
RUN dotnet publish "HanWeatherTest.csproj" -c Release -o /app/publish

FROM base AS final
WORKDIR /app
#COPY --from=publish /app/publish .
COPY --from=publish /app/ .
#ENTRYPOINT ["dotnet", "HanWeatherTest.dll"]
CMD ASPNETCORE_URLS=http://*:$PORT dotnet HanWeatherTest.dll